...
public class EncoderKeepStraightPID extends PIDCommand {
	...
	public EncoderKeepStraightPID(double timeout){
		super(RobotMap.DriveBaseConstants.P_ENCODER_STRAIGHT, RobotMap.DriveBaseConstants.I_ENCODER_STRAIGHT, RobotMap.DriveBaseConstants.D_ENCODER_STRAIGHT);
    ...
    protected boolean isFinished() {
    	if((Robot.driveBase.isDistanceOnTarget() && Robot.driveBase.isStraight()) || this.isTimedOut()){
    		SmartDashboard.putNumber("finalEncoderDif", Robot.driveBase.getRightEncoderValue() - Robot.driveBase.getLeftEncoderValue());
    		return true;
    	}
        return false;
    }
	...
	protected double returnPIDInput() {
		return Robot.driveBase.getRightEncoderValue() - Robot.driveBase.getLeftEncoderValue();
	}
