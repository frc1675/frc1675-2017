...
public class OI {
	...
	public OI(){
		operatorAButton.whileHeld(new Elevate(RobotMap.ElevatorConstants.FORWARD_POWER));
		operatorYButton.whileHeld(new Elevate(RobotMap.ElevatorConstants.BACKWARDS_POWER));
	}
